...
def create_halftone_with_qr(qr_img, dpi=2400, height_cm=1):
    """
    创建半色调点矢量图并与二维码拼接
    ...
    # 绘制所有点
    for (x, y) in points:
        draw.ellipse([x - dot_radius_px, y - dot_radius_px,
                      x + dot_radius_px, y + dot_radius_px], fill=0)
